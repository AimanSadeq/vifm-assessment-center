# Competency Items — Clusters 2–8 (SJT + CBI)

**Companion to:** `competency-items-cluster1.md` (the worked model, incl. the
...
**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe a situation with many moving parts and unclear information
you had to make sense of." *Probes:* How did you structure it? What did you
prioritise?
...
**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe how you used a digital tool or data to improve how work got
done." *Probes:* What changed? What was the benefit?
...
- D. Assume another team is handling it.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about something you started or fixed without being asked."
...
- B. Tell them as soon as you know, with a revised date and a plan.
- C. Deliver late without comment.
- D. Blame competing priorities when asked.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about a time you couldn't meet a commitment. What did you
do?" *Probes:* How and when did you communicate? Outcome?

### 13. Planning & Prioritisation · *Locke & Latham (2002); Barrick & Mount (1991)*
**(A) SJT.** You have five tasks due this week and can't do them all well.
MOST / LEAST:
- A. Start with the easiest to clear the list.
- B. Rank by impact and deadline, focus on the highest-value items, and
  renegotiate the rest.
- C. Attempt all five at once.
...
information." *Probes:* How did you proceed? How did you revisit as things
clarified?
...
- D. Hand the work to someone more experienced.

**Key:** MOST = **B**; LEAST = **C**.
**(B) CBI.** "Tell me about quickly getting up to speed on something unfamiliar."
...
period." *Probes:* How did you frame it? How did they respond?
...
work. MOST / LEAST:
- A. Let them sort it out themselves indefinitely.
- B. Bring them together, focus on the task issue (not personalities), and agree a
  way forward.
- C. Side with the more senior one to end it.
- D. Separate their work permanently to avoid contact.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe a conflict you helped resolve." *Probes:* How did you keep
...
sides." *Probes:* How did you uncover their real needs?

### 23. Relationship Networks · *Burt (1992); Ibarra (1993)*
**(A) SJT.** You interact only with your immediate team and now need cross-org
support for an initiative. MOST / LEAST:
...
**Key:** MOST = **B**; LEAST = **D**.
**(B) CBI.** "Describe how you built relationships that later helped you deliver."
*Probes:* How did you invest before you needed them?

---

## Cluster 6 — Leading & Developing Others

### 24. Coaching & Talent Growth · *Ellinger, Ellinger & Keller (2003)*
**(A) SJT.** A capable team member keeps bringing you problems to solve.
MOST / LEAST:
- A. Solve each problem for them to save time.
- B. Ask questions that help them develop their own solution, then give feedback.
- C. Tell them to stop bothering you.
- D. Reassign their harder tasks to someone senior.

**Key:** MOST = **B**; LEAST = **C**.
**(B) CBI.** "Tell me about developing someone." *Probes:* How did you help them
grow rather than solving it for them?

### 25. Building Cohesive Teams · *Salas, Sims & Burke (2005)*
**(A) SJT.** A newly merged team has cliques and low trust. MOST / LEAST:
- A. Hope it settles over time.
- B. Set shared goals and norms, create joint work, and address tensions openly.
- C. Keep the cliques apart on separate tasks.
- D. Replace the members who don't fit.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe building or rebuilding a team's cohesion." *Probes:* What
...
**Key:** MOST = **B**; LEAST = **D**.
**(B) CBI.** "Tell me about delivering something that needed another unit with
different priorities." *Probes:* How did you align?

### 27. Trust & Credibility · *Mayer, Davis & Schoorman (1995)*
**(A) SJT.** You made a commitment to a peer, but circumstances changed.
MOST / LEAST:
- A. Quietly drop it and hope it's forgotten.
- B. Proactively tell them, explain honestly, and propose how to make good.
- C. Deliver something half-done to technically comply.
- D. Deny you ever committed to it.

**Key:** MOST = **B**; LEAST = **D**.
**(B) CBI.** "Describe a time your reliability was tested." *Probes:* How did you
handle a commitment under strain?
...
- D. Mimic them so completely you lose your own position.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about adapting your style to work with someone very
different." *Probes:* What did you change? What stayed constant?

---

## Cluster 7 — Integrity & Character

### 29. Self-Insight · *Church (1997)*
**(A) SJT.** Feedback says your decisiveness sometimes shuts down input.
MOST / LEAST:
- A. Dismiss it; decisiveness is your strength.
- B. Reflect, seek specifics, and experiment with inviting input before deciding.
- C. Overcorrect and stop deciding anything yourself.
- D. Agree publicly but change nothing.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe feedback that changed how you see yourself, and what you
did." *Probes:* How did you act on it?

### 30. Emotional Regulation & Empathy · *Mayer, Salovey & Caruso (2008)*
**(A) SJT.** A colleague snaps at you in a tense meeting. MOST / LEAST:
- A. Snap back to defend yourself.
- B. Stay composed, and follow up later to understand what's going on.
- C. Report them immediately, without context.
...
- D. Go along now and document your disagreement later.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe speaking up about something difficult or unpopular."
...
**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about facing pressure to compromise a standard." *Probes:*
...
- C. Exclude them from meetings they can't make.
- D. Make a silent exception without addressing the pattern.

**Key:** MOST = **B**; LEAST = **C**.
**(B) CBI.** "Describe working across cultural or background differences."
*Probes:* How did you adapt and include?

---

## Cluster 8 — Growth & Personal Effectiveness

### 34. Adaptive Learning Capacity · *DeRue, Ashford & Myers (2012)*
**(A) SJT.** You're moved into an unfamiliar role with new demands. MOST / LEAST:
- A. Apply exactly what worked in your old role.
- B. Identify what's different, seek input, and adjust your approach quickly.
- C. Wait until you fully understand everything before acting.
- D. Assume the new role is basically the same.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about performing in a first-time situation." *Probes:* How
did you adjust prior approaches?

### 35. Continuous Self-Development · *Maurer & Tarulli (1994)*
**(A) SJT.** You receive critical feedback in a review. MOST / LEAST:
- A. Defend yourself and move on.
- B. Turn it into a concrete development plan and seek chances to practise.
- C. Wait for the company to provide training.
...
**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Tell me about a high-pressure moment you had to lead through."
*Probes:* How did you stay effective?

### 37. Sustainable Wellbeing · *Bakker & Demerouti (2007)*
**(A) SJT.** Your team is heading into a sustained high-demand period. MOST / LEAST:
- A. Push everyone at maximum until it's over.
- B. Manage workload and recovery, secure resources, and watch for burnout signs.
- C. Tell people to manage their own stress.
- D. Quietly lower quality standards to cut effort.

**Key:** MOST = **B**; LEAST = **A**.
**(B) CBI.** "Describe managing sustained demands on you or your team." *Probes:*
How did you sustain performance over time?

### 38. Resource Mobilisation · *Kanungo & Misra (1992)*
**(A) SJT.** You're handed a priority project with no extra budget or people.
MOST / LEAST:
- A. Decline, citing a lack of resources.
- B. Identify and negotiate for the critical resources, repurpose what you have,
  and sequence smartly.
- C. Proceed with nothing and hope it works out.
- D. Quietly pull people off other work without telling anyone.

**Key:** MOST = **B**; LEAST = **D**.
**(B) CBI.** "Tell me about delivering with limited resources." *Probes:* How did
you secure or repurpose what you needed?
