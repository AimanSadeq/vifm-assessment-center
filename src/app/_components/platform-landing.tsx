...
const T = {
  en: {
    ...
    services: {
      ...
      cognitive: { tagline: "Reasoning aptitude", name: "Logical®", description: "Indicative numerical, verbal, inductive and deductive reasoning - a foundational read on aptitude. Server-scored, admin-run and bilingual.", tooltip: "Best for a foundational read on reasoning and aptitude." },
  ...
  ar: {
    ...
    services: {
      ...
      cognitive: { tagline: "القدرة على الاستدلال", name: "لوجيكال", description: "مقاييس استرشادية للاستدلال العددي واللفظي والمجرّد - قراءة تأسيسية للقدرات. تُصحَّح على الخادم، يُجريها المسؤول، وثنائية اللغة.", tooltip: "الأنسب لقراءة تأسيسية للاستدلال والقدرات." },
