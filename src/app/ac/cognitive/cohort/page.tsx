...
export const metadata = { title: "Logical® · Cohort report" };
    ...
    <div className="min-h-screen bg-[#F5F7FA]">
      <header className="border-b bg-white">
        <div className="max-w-5xl mx-auto px-6 py-5">
          ...
          >
            <ArrowLeft className="h-3 w-3" /> Back to Logical®
          </Link>
          <div className="flex items-center gap-2">
            <Users className="h-5 w-5 text-[#5391D5]" />
            <h1 className="text-xl font-semibold text-[#010131]">Logical® cohort report</h1>
          ...
          <Link href="/admin/cohorts" className="mt-2 inline-block text-xs font-medium text-[#5391D5] hover:underline">
            View combined project cohorts (Persona + Logical) →
          </Link>
        </div>
      </header>
