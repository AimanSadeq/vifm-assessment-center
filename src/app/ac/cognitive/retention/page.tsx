...
export const metadata = { title: "Reason retention · VIFM" };
  ...
  return (
    <div className="max-w-4xl mx-auto px-6 py-8">
      ...
      <div className="mt-4 mb-2 flex items-center gap-2">
        ...
        <h1 className="text-2xl font-semibold text-[#010131]">Reason retention</h1>
      </div>
      <p className="text-sm text-muted-foreground mb-6">
        Candidate data is retained for a maximum of {RETENTION_MONTHS / 12} years. Purge Reason
