...
export const metadata = { title: "Logical® vouchers · VIFM" };
  ...
  return (
    <div className="max-w-6xl mx-auto px-6 py-8">
      ...
      <div className="mt-4 mb-6">
        <h1 className="text-2xl font-semibold text-[#010131]">Logical® vouchers</h1>
        <p className="text-sm text-muted-foreground">
          Generate redeemable Logical assessment access codes, tag them to a client, and track seats.
