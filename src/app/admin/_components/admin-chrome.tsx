  ...
  return (
    <div className="flex h-screen overflow-hidden">
      ...
      <div className="flex min-w-0 flex-1 flex-col">
        ...
        {/* Desktop top bar - All services + bell, right-aligned. Extra right
            padding reserves the top-right corner for the global SessionIndicator
            pill (fixed, in the root layout) so it never covers the bell. */}
        <div className="hidden items-center justify-end gap-2 border-b bg-card py-2 pl-6 pr-48 lg:flex">
          <AllServicesLink />
