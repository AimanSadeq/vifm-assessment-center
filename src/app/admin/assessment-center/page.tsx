...
export default async function AssessmentCenterDashboardPage() {
  ...
  return (
    <>
      <BackLink href="/admin" label={t("adminNav.adminHome")} history />
      ...
      <section className="ara-hero relative overflow-hidden rounded-2xl mb-6 mt-3">
