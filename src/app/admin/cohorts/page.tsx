    ...
    <div className="mx-auto max-w-5xl space-y-6 p-6">
      ...
      <header>
        ...
        <p className="mt-1 max-w-3xl text-sm text-muted-foreground">
          Persona (behavioural self-report) and Cognitive (ability) results for one cohort, grouped by
      ...
      {!migrated && (
        <div className="rounded-lg border border-amber-300 bg-amber-50 px-4 py-3 text-sm text-amber-900">
          ...
          <code className="text-xs">00137_project_cohort_label.sql</code>, then issue Persona / Cognitive
      ...
      {migrated && labels.length === 0 && (
        <div className="rounded-lg border bg-white px-4 py-10 text-center text-sm text-muted-foreground shadow-sm">
          ...
          Cognitive voucher batch to group those runs here.
        </div>
      )}
      ...
      {selected && (
        <>
          <div className="grid gap-4 sm:grid-cols-4">
            ...
            <StatCard label="Cognitive taken" value={String(cognitive.length)} />
            <StatCard
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            ...
            <div className="rounded-xl border bg-white p-4 shadow-sm">
              <p className="inline-flex items-center gap-2 text-[11px] uppercase tracking-wider text-slate-500">
                <BrainCircuit className="h-3.5 w-3.5 text-[#5391D5]" /> Cognitive avg (g)
              </p>
              <p className="mt-1 text-2xl font-bold text-[#010131]">
              ...
              <table className="w-full text-sm">
                <thead>
                  <tr className="border-b text-left text-[11px] uppercase tracking-wider text-slate-500">
                    ...
                    <th className="px-3 py-2.5 text-center font-medium">Cognitive (g)</th>
                        ...
                        <div className="flex items-center gap-3">
                          ...
                          {row.cognitive && (
                            <a
                              ...
                              className="inline-flex items-center gap-1 text-xs font-medium text-[#5391D5] hover:underline"
                            >
                              <FileText className="h-3.5 w-3.5" /> Cognitive
                            </a>
                          )}
                        </div>
                      </td>
          ...
          <p className="text-xs text-muted-foreground">
            These are indicative self-served instruments. Persona is a behavioural self-report; Cognitive
