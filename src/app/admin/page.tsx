...
export default async function AdminDashboardPage() {
  ...
  const steps: ProcessStep[] = [
    ...
    { id: "observations", number: 4, title: "Monitor Observations", href: "/admin/analytics", iconName: "Eye", metric: o, metricLabel: "observations", isComplete: o > 0, isActive: a > 0 && o === 0 },
