...
const EN: Dict = {
  ...
  maturity_short: "Maturity",
  weighted_aggregate: "Weighted aggregate",
  pillars_at_above_benchmark: "Pillars \u2265 4.00",
  pillars_requiring_focus: "Pillars requiring focus",
  no_strengths_panel: "No pillars at Advancing or above yet.",
  no_gaps_panel: "No pillars below Developing - solid foundation.",
  not_validated: "not validated",
  self_short: "self",
  consultant_short: "cons",
  unscored: "Unscored",
  ...
  // Body paragraphs
  exec_intro: "This assessment measures the organization across the in-scope AI Readiness pillars. The overall score is a weighted average of pillar-level maturity; regulatory compliance is assessed separately against the frameworks applicable to the client's region.",
  ...
  how_to_read_intro: "This report summarises findings across the in-scope AI Readiness pillars. Each pillar is scored 1-5 against a behavioural rubric, and the overall score is a weighted aggregate.",
  ...
  heatmap_critical: "Unaware (below 2.0)",
  heatmap_early: "Exploring (2.0-2.9)",
  heatmap_developing: "Developing (3.0-3.9)",
  heatmap_ready: "Advancing+ (4.0 and above)",
  ...
  appendix_scoring: "Each pillar raw score is the average of answered questions on a 1-5 scale. The overall organizational score is the weighted average of the scored, in-scope pillars: each pillar contributes its raw score × its pillar weight, with weights renormalised over the pillars that were actually scored.",
...
const AR: Dict = {
  ...
  gap: "الفجوة",
  benchmark_gap: "الفجوة مقابل المعيار",
  maturity_band: "نطاق النضج",
  maturity_short: "النضج",
  weighted_aggregate: "مجموع مرجح",
  pillars_at_above_benchmark: "ركائز \u2265 ٤٫٠٠",
  pillars_requiring_focus: "ركائز تتطلب التركيز",
  no_strengths_panel: "لا توجد ركائز في مستوى يتقدم أو أعلى بعد.",
  no_gaps_panel: "لا توجد ركائز دون مستوى يطور - أساس متين.",
  not_validated: "غير مُتحقق",
  self_short: "ذاتي",
  consultant_short: "مستشار",
  ...
  exec_intro: "يقيس هذا التقييم المنظمة عبر ركائز الاستعداد للذكاء الاصطناعي المشمولة في النطاق. والنتيجة الإجمالية هي متوسط مرجح لنضج الركائز؛ أما الامتثال التنظيمي فيُقيَّم بصورة منفصلة وفق الأطر السارية في منطقة العميل.",
  no_strengths: "لا توجد ركائز تسجل حالياً في مستوى متقدم أو أعلى.",
  no_gaps: "لا توجد ركائز دون مستوى النضج النامي - أساس متين.",
  how_to_read_intro: "يلخص هذا التقرير النتائج عبر ركائز الاستعداد للذكاء الاصطناعي المشمولة في النطاق. تُقيَّم كل ركيزة من ١ إلى ٥ وفقاً لمعايير سلوكية، وتمثل النتيجة الإجمالية مجموعاً مرجحاً.",
  ...
  heatmap_critical: "غير مدرك (أقل من ٢٫٠)",
  heatmap_early: "يستكشف (٢٫٠-٢٫٩)",
  heatmap_developing: "يطور (٣٫٠-٣٫٩)",
  heatmap_ready: "يتقدم فأعلى (٤٫٠ فأكثر)",
  ...
  appendix_scoring: "كل نتيجة ركيزة خام هي متوسط الأسئلة المجابة على مقياس ١-٥. النتيجة التنظيمية الإجمالية هي المتوسط المرجح للركائز المشمولة والمقيَّمة: تسهم كل ركيزة بنتيجتها الخام × وزنها، مع إعادة معايرة الأوزان على الركائز المقيَّمة فعلياً.",
