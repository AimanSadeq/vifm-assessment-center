...
const EN: Dict = {
  ...
  no_strengths_panel: "No pillars at Advanced or above yet.",
...
const AR: Dict = {
  ...
  no_strengths_panel: "لا توجد ركائز في مستوى متقدم أو أعلى بعد.",
  no_gaps_panel: "لا توجد ركائز دون مستوى النامي - أساس متين.",
