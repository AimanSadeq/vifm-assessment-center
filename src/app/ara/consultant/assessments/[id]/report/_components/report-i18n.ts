...
const EN: Dict = {
  ...
  // Body paragraphs
  exec_intro: "This assessment benchmarks the organization across the in-scope AI Readiness pillars. The overall score reflects a weighted aggregate of pillar-level maturity, calibrated against regional regulatory frameworks.",
...
const AR: Dict = {
  ...
  exec_intro: "يقارن هذا التقييم المنظمة عبر ركائز الاستعداد للذكاء الاصطناعي المشمولة في النطاق. تعكس النتيجة الإجمالية مجموعاً مرجحاً لنضج الركائز، معايراً وفقاً للأطر التنظيمية الإقليمية.",
