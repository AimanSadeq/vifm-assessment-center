...
export default async function AssessorDashboardPage() {
  ...
  const steps: ProcessStep[] = [
    ...
    { id: "observe", number: 2, title: "Observe Candidates", href: "/assessor/assignments", iconName: "Eye", metric: o, metricLabel: "observations", isComplete: o > 0, isActive: a > 0 && o === 0 },
    ...
    { id: "integrate", number: 4, title: "Complete Integration", href: "/assessor/assignments", iconName: "FileStack", metric: w, metricLabel: "worksheets", isComplete: w > 0, isActive: r > 0 && w === 0 },
