...
export default async function ClientDashboardPage() {
  ...
  const steps: ProcessStep[] = [
    { id: "engagements", number: 1, title: t("clientPortal.dashboard.stepEngagementsTitle"), href: "/client/engagements", iconName: "ClipboardList", metric: e, metricLabel: t("clientPortal.dashboard.stepEngagementsMetric"), isComplete: e > 0, isActive: e === 0 },
    { id: "candidates", number: 2, title: t("clientPortal.dashboard.stepCandidatesTitle"), href: "/client/engagements", iconName: "Users", metric: c, metricLabel: t("clientPortal.dashboard.stepCandidatesMetric"), isComplete: c > 0, isActive: e > 0 && c === 0 },
    { id: "results", number: 3, title: t("clientPortal.dashboard.stepResultsTitle"), href: "/client/reports", iconName: "BarChart3", metric: oar, metricLabel: t("clientPortal.dashboard.stepResultsMetric"), isComplete: oar > 0, isActive: c > 0 && oar === 0 },
    { id: "reports", number: 4, title: t("clientPortal.dashboard.stepReportsTitle"), href: "/client/reports", iconName: "FileText", metric: rel, metricLabel: t("clientPortal.dashboard.stepReportsMetric"), isComplete: rel > 0, isActive: oar > 0 && rel === 0 },
    { id: "analytics", number: 5, title: t("clientPortal.dashboard.stepAnalyticsTitle"), href: "/client/analytics", iconName: "TrendingUp", metric: oar, metricLabel: t("clientPortal.dashboard.stepAnalyticsMetric"), isComplete: oar > 0 && rel > 0, isActive: rel > 0 },
  ];
      ...
      <section className="ara-hero relative overflow-hidden rounded-2xl mb-6">
        <div className="px-6 py-8 sm:px-8 sm:py-10 relative z-10">
          <span className="ara-eyebrow text-accent">
            ...
            {t("clientPortal.dashboard.eyebrow")}
          </span>
          ...
          <p className="text-sm text-white/75 max-w-2xl">
            {t("clientPortal.dashboard.intro")}
          </p>
          <div className="flex flex-wrap items-center gap-2.5 mt-5">
            <span className="inline-flex items-center gap-1.5 text-xs font-medium text-white px-3.5 py-1.5 rounded-full border border-white/25 bg-white/10 backdrop-blur">
              ...
              {t("clientPortal.dashboard.badge", { engagements: e, candidates: c })}
            </span>
          </div>
        </div>
      </section>
      <ProcessMap
        title={t("clientPortal.dashboard.title")}
        subtitle={t("clientPortal.dashboard.mapSubtitle")}
        steps={steps}
