...
export const FLUENT_PROMPT_SEED_V1: FluentPromptSeed[] = [
  // ── Writing (8) ────────────────────────────────────────────────
  {
    ...
    prompt_en: "Write a short message (about 50 words) to a colleague to say you will be late for a meeting and why.",
    prompt_ar: "اكتب رسالة قصيرة (نحو 50 كلمة) إلى زميل لتخبره بأنك ستتأخر عن اجتماع وسبب ذلك.",
  },
  {
    skill: "writing", cefr: "A2", min_words: 50,
    prompt_en: "Write a short email (about 60 words) to book a meeting room for next Tuesday morning and say how many people will attend.",
    prompt_ar: "اكتب بريدًا إلكترونيًا قصيرًا (نحو 60 كلمة) لحجز قاعة اجتماعات صباح الثلاثاء المقبل مع ذكر عدد الحاضرين.",
  },
  {
  ...
  {
    skill: "writing", cefr: "B2", min_words: 90,
    prompt_en: "Write a short summary (about 100 words) of a problem your team faced recently and the action you recommend to prevent it happening again.",
    prompt_ar: "اكتب ملخصًا قصيرًا (نحو 100 كلمة) لمشكلة واجهها فريقك مؤخرًا والإجراء الذي توصي به لمنع تكرارها.",
  },
  {
    skill: "writing", cefr: "C1", min_words: 120,
    prompt_en: "Write a short briefing note (about 130 words) recommending whether your organisation should adopt a new tool. Weigh one benefit against one risk and give a clear recommendation.",
    prompt_ar: "اكتب مذكرة إحاطة قصيرة (نحو 130 كلمة) توصي فيها بما إذا كان ينبغي لمؤسستك اعتماد أداة جديدة. وازِن بين فائدة واحدة ومخاطرة واحدة وقدّم توصية واضحة.",
  },
  {
    skill: "writing", cefr: "C1", min_words: 120,
    prompt_en: "Write a short response (about 130 words) to a stakeholder who disagrees with a decision your team made. Acknowledge their concern and justify the decision professionally.",
    prompt_ar: "اكتب ردًا قصيرًا (نحو 130 كلمة) على أحد أصحاب المصلحة يعترض على قرار اتخذه فريقك. أقرّ بمخاوفه وبرّر القرار بأسلوب مهني.",
  },
  ...
  {
    skill: "speaking", cefr: "B1", min_seconds: 40,
  ...
  {
    skill: "speaking", cefr: "B2", min_seconds: 45,
    prompt_en: "Speak for about 50 seconds: describe a decision you disagreed with at work and explain how you handled the situation.",
    prompt_ar: "تحدّث لمدة 50 ثانية تقريبًا: صِف قرارًا اختلفت معه في العمل ووضّح كيف تعاملت مع الموقف.",
  },
  {
