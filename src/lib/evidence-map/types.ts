...
export const INSTRUMENTS: readonly InstrumentMeta[] = [
  ...
  { key: "fluent", label: "Fluent (English)" },
  { key: "technical", label: "Technical Cert", href: "/admin/tech-assessment/items" },
  { key: "reflect", label: "Reflect 360" },
  { key: "psy", label: "Psychometrics", href: "/admin/psychometrics" },
];
...
export type EvidenceMetrics = {
  ...
  fluent: { items: number | null; live: number | null; calibrated: number | null; humanRatings: number | null; results: number | null };
  technical: { items: number | null; approved: number | null; calibrated: number | null; cutScores: number | null; results: number | null };
  reflect: { competencies: number | null; behaviors: number | null; behaviorsAi: number | null; responses: number | null };
  psy: { items: number | null; approved: number | null; norms: number | null; itemResponses: number | null; results: number | null };
};
