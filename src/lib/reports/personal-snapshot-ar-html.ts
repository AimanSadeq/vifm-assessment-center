...
// already renders in English. These are first-draft translations
// written in Modern Standard Arabic with GCC-business register;
// hand-review by a native Arabic professional before public release.
// ────────────────────────────────────────────────────────────────
...
> = {
  thinking_sense_check: {
    ...
    practising:
      "تتحقق من عمل الذكاء الاصطناعي، لكن غالباً حين يبدو شيء ما خطأ فقط. حدّد محفزات صريحة (ادعاءات عالية المخاطر، مجالات غير مألوفة) تدفعك إلى التحقق تلقائياً، حتى لا تعتمد العادة على الشك.",
    embedded:
      "ترصد الهلوسة بشكل طبيعي. شارك أساليب التحقق مع فريقك ودوّنها في بروتوكول يستطيع الآخرون اتباعه عندما لا تكون في الغرفة.",
  },
  results_working_practice: {
    emerging:
      "اختر مهمة متكررة وادمج الذكاء الاصطناعي فيها لمدة أسبوعين. تتبّع الوقت الموفّر — هذه البيانات تبني الثقة أسرع من التجريب العشوائي عبر كل شيء تفعله.",
    practising:
      "تستخدم الذكاء الاصطناعي في عمل حقيقي. استثمر الآن في قوالب التعليمات وسير العمل القابلة لإعادة الاستخدام لتتراكم إنتاجيتك بدلاً من البدء من الصفر في كل مرة.",
    embedded:
      "الذكاء الاصطناعي جزء من طريقة عملك. دوّن أنماط سير العمل الأقوى لديك ليتبناها زملاؤك دون الحاجة إلى إعادة اختراع العجلة — يضاعف ذلك أثرك بعيداً عن لوحة مفاتيحك.",
  },
  people_collaboration: {
    ...
    practising:
      "تشارك بشكل مفيد. ادفع الأمر أبعد — ادع زملاءك لطرح أسئلتهم عن الذكاء الاصطناعي عليك، وحدّد لقاءً منتظماً مدته 15 دقيقة ليقارن الفريق التعليمات والأنماط.",
    embedded:
      "أنت مضاعِف لتبنّي الذكاء الاصطناعي. ترصّد إشارات الاعتماد المفرط (زملاء يأخذون المخرجات على ظاهرها) وأشِر إليها بشكل بنّاء قبل أن تظهر في تسليم.",
  },
  self_adaptive_mindset: {
    ...
    embedded:
      "تتكيف بسلاسة. وظّف هذه القدرة لإرشاد شخص في بداية رحلته مع الذكاء الاصطناعي — التعليم يرسّخ تكيّفك ويكشف نقاط ضعفك.",
  },
};
...
> = {
  emerging: {
    ...
    bullets: [
      "اختر العامل الذي حصل على أدنى درجة وطبّق إرشادات هذا العامل من الصفحة الأولى لمدة أسبوعين. لا تحاول رفع العوامل الأربعة دفعة واحدة.",
      "حدّد موعداً أسبوعياً مدته 30 دقيقة مخصصاً لممارسة الذكاء الاصطناعي. بدون موعد ثابت في التقويم، لن تتشكّل العادة.",
      "ابحث عن شخص في فريقك متقدّم عليك في الذكاء الاصطناعي — زميل لا مدير — واطلب منه أن يشاركك تعليمة (Prompt) يثق بها. الاستعارة أسرع من البدء من الصفر.",
    ],
  },
  practising: {
    title: "ركّز هنا تالياً",
    bullets: [
      ...
      "اقرن أقوى عامل لديك بأضعف عامل: استخدم القدرة التي بنيتها لتتوسع في المنطقة التي تتجنبها. غالباً ما ترفع «الممارسة العملية» معها «تحقّق الذكاء الاصطناعي».",
      "اعرض هذا الشهر نتيجة ملموسة أنجزتها بمساعدة الذكاء الاصطناعي على مديرك أو فريقك — كسب في السرعة، تحسّن في الجودة، أو خطأ تم رصده. الظهور يفتح أبواب الاستثمار.",
    ],
  },
  embedded: {
    title: "ركّز هنا تالياً",
    bullets: [
      ...
      "راجع أحد مهامك المعتمدة على الذكاء الاصطناعي من حيث الإنصاف والسرية ومطابقة السياسات. المستخدمون الراسخون يفاجئهم سوء الحوكمة، لا الأدوات.",
      "أرشد شخصاً في المرحلة الناشئة — فعل التعليم يكشف ثغرات في نموذجك الخاص ويُصلب حُكمك.",
    ],
  },
};
...
const HOW_TO_USE_PANELS_AR = {
  read: {
    ...
    bullets: [
      "1.0 - 2.9 — فرصة. منطقة بناء الأساس؛ الممارسة المتعمَّدة ستحرّك العقرب بسرعة.",
      "3.0 - 3.9 — متطوّر. العادة قائمة؛ المكسب القادم هو جعلها موثوقة لا ظرفية.",
  ...
  about: {
    ...
    bullets: [
      ...
      "كل عامل مرتبط بكفاءات مركز تقييم VIFM التي قد تعمل عليها فعلاً — فيتراكم نموّك في الذكاء الاصطناعي مع باقي تطوّرك.",
