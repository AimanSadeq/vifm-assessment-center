      ...
      <Page size="A4" style={s.page} wrap>
        ...
        <View style={s.hero}>
          ...
          <View style={s.heroPillRow}>
            ...
            <Text style={s.heroPill}>{data.kind === "cognitive" ? "Reason" : "Personality · Big Five"}</Text>
          </View>
        </View>
      ...
      <Page size="A4" style={s.page} wrap>
        ...
        <View style={s.disclaimerBox}>
          ...
          <Text style={s.disclaimerBody}>
            {data.kind === "cognitive"
              ? "Reason is estimated from numerical, verbal, inductive and deductive reasoning items, scored as % correct per subtest with a general (g) composite. "
