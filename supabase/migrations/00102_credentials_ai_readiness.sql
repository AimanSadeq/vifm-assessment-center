...
-- personal AI-readiness assessment (free personal snapshot, paid personal deep-dive, or a
-- departmental-plus-personal individual respondent). It is checkable at /verify/[code], parallel to
